...
public class RentalSubMenu {
        ...
        do {
            ...
            try {
                ...
                if (dateTime.isBefore(LocalDateTime.now())) {
                    System.out.println("A data informada deve ser maior do que a data atual. Tente novamente.");
                    dateTime = null;
                }
            } catch (DateTimeParseException e) {
                System.out.println("A data deve ser informada no formato dd/MM/yyy hh:mm. Tente novamente.");
            }
        } while (dateTime == null);
        return dateTime;
    }
        ...
        do {
            ...
            try {
                ...
                if (dateTime.isBefore(start)) {
                    System.out.println("A data de devolução não pode ser anterior à data de retirada. Tente novamente.");
                    dateTime = null;
                }
            } catch (DateTimeParseException e) {
                System.out.println("A data deve ser informada no formato dd/MM/yyy hh:mm. Tente novamente.");
    ...
    private Vehicle getVehicle(Company companyWithdrawal) {
        ...
        do {
            System.out.print("Informe a placa do veículo para a reserva: ");
    ...
    private Client getClient() {
        ...
        do {
            ...
            try {
                ...
                System.out.println("Cliente não encontrado. Informe um CPF ou CNPJ cadastrado!");
            }
    ...
    public void devolverVeiculo() {
        ...
        do {
            ...
            if(found){
                ...
                System.out.println("Aluguel não encotrado. Tente novamente.");
            }
